<template>
  <div>
    ...
    <template v-else>
      ...
      <template v-if="noBalances">
        <TypographyCategoryLabel>
          To start using Revolution ecosystem, deposit tokens in any convenient way
        </TypographyCategoryLabel>
      ...
      <template v-else>
        <TypographyCategoryLabel>Deposit more tokens to Revolution</TypographyCategoryLabel>
